  ...
  <div class="w-full">
    ...
    <div class="tabs w-full py-5">
      <ul class="nav-tabs flex space-x-4 ">
        <li @click="updateInfo = false" :class="updateInfo ? 'border-red-500' : 'border-gray-200'" class="py-1 border-b   text-gray-500  leading-10 hover:border-b cursor-pointer">Request Access</li>
  ...
  methods: {
    ...
    if(this.data.some((item)=> item.selectedValue ==='')) {
      ...
      this.$axios.post('/api/sendmail',{
        ...
        name:'Gilead Bioinformatics - Tableau',
