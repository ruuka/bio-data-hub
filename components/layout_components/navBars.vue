      ...
      <div class="relative flex items-center justify-between h-16">
        ...
        <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
          <div class="flex-shrink-0 flex items-center">
            <img class="block lg:hidden h-10 w-auto" src="https://anima-uploads.s3.amazonaws.com/projects/61eb071259085a6271779ae5/releases/61eb07172db43d929ddc59c6/img/gilead-create-possible-svg-1@2x.svg" alt="Gilead">
            <img class="hidden lg:block h-10 w-auto" src="https://anima-uploads.s3.amazonaws.com/projects/61eb071259085a6271779ae5/releases/61eb07172db43d929ddc59c6/img/gilead-create-possible-svg-1@2x.svg" alt="Gilead">
          </div>
        ...
        <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
          <button type="button" class="bg-gray-800 p-1 rounded-full text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
            ...
            <div class="m-2 indicator">
              <div class="indicator-item indicator-top indicator-end badge badge-secondary">3</div>
          ...
          <div class="ml-3 relative">
            <div>
              <button type="button" class="bg-gray-600 flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                <span class="sr-only">Open user menu</span>
<!--                <img class="h-8 w-8 rounded-full" src="" alt="">-->
                <svg class="h-8 w-8 rounded-full text-gray-400 bg-gray-100 " fill="currentColor" viewBox="0 0 24 24">
