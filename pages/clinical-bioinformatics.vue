  ...
  <div class="flex w-full bg-[#F9F9FC]">
    <div class="w-full h-full overflow-y-auto px-2 py-4">
      ...
      <div class="bg-white shadow-sm w-full rounded mt-2">
        <h4 class="text-xl lg:text-2xl px-3 py-2 leading-tight text-black">
          New Publications
        </h4>
      </div>
      ...
      <section class="my-5">
        ...
        <div class="flex w-1/2 gap-4 items-center">
          <input
            ...
            placeholder="Search by trial, nickname, indication, product..."
          />
        </div>
        ...
        <div class="flex items-center gap-4 px-4 py-3">
          <span>
            ...
            >
              <path
                d="M15.2777 5H4.16663L8.61107 10.2556V13.8889L10.8333 15V10.2556L15.2777 5Z"
                stroke="#242533"
                stroke-width="1.2"
          ...
          >
            <input
              ...
              name=""
              class="default:ring-2 accent-primary h-4 w-4 border border-primary ring-primary checked:bg-primary"
              id=""
            />
              ...
              <td class="w-1/4 border bg-[#644ded14] px-2 py-3">
                <div class="flex justify-between items-center">
                  ...
                  <span>
                    ...
                    >
                      <path
                        d="M2.26783 3.19037L4.62494 0.833253L6.98206 3.19037"
                        stroke="#242533"
                        stroke-width="1.2"
                        stroke-linecap="round"
                        stroke-linejoin="round"
                      />
                      <path
                        d="M4.62499 0.833285L4.62499 9.08319"
                        stroke="#242533"
                        stroke-width="1.2"
                        stroke-linecap="round"
                        stroke-linejoin="round"
                      />
                      <path
                        d="M13.5654 7.55939L11.2083 9.9165L8.85114 7.55939"
                        stroke="#242533"
                        stroke-width="1.2"
                        stroke-linecap="round"
                        stroke-linejoin="round"
                      />
                      <path
                        d="M11.2082 1.66666L11.2082 9.91656"
                        stroke="#242533"
                        stroke-width="1.2"
                        stroke-linecap="round"
                        stroke-linejoin="round"
            ...
            >
              ...
              <td class="border px-2 py-3">
                <a
                  ...
                  target="_blank"
                  class="px-3 bg-[#644DED] underline px-3 py-2 rounded bg-opacity-80 text-[#644DED] bg-opacity-20"
                  >Download</a
                >
              </td>
            </tr>
