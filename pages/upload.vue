        ...
        >
          ...
          >
            ...
            <div class="form-control w-full">
              ...
              <p
                class="mt-2 text-slate-400 text-xs font-light text-center w-full"
              >
                .doc or .docx only
              </p>
              <div class="w-full">
                <ul v-if="imagesArray" class="flex w-full flex-col text-sm">
                  <li
                    v-for="(file, index) in imagesArray"
                    :key="index"
                    class="flex gap-3 text-gray-500 justify-between items-center"
                  >
                    <span>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span
                      class="text-red opacity-50 hover:opacity-100"
...
export default {
  ...
  data() {
    return {
      ...
      notificationMessage:
        'Be patient, please submit one file per request to avoid overloading the server, thank you!',
  ...
  methods: {
    ...
    removeFile(index) {
      this.imagesArray = [...this.imagesArray].filter(
        (_s, indx) => index !== indx
      )
    },
    onUpload() {
    ...
    fileCheck(event) {
      ...
      const ext = this.uploadedFile.substring(
